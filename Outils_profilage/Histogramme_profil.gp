...
set title "Temps moyen d'exécution pour chaque sous-partie de miniXyce\n4 processus MPI" font "Helvetica,16"
...
plot 'Resultats_mesures/Traitement_donnees_proc4.dat' using 2:3:xtic(1) lc "blue", '' using 0:2:4 with labels offset 0, char 1 font ",8"
