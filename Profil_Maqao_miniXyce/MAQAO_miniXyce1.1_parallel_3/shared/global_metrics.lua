_report = {
  metrics = {
    ...
    loops_time = 32.5,
    speedup_if_fp_vect = "1.06",
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = "1.23",
    speedup_if_perfect_MPI_OMP_PTHREAD = "1.08",
    speedup_if_L1 = "Not Available",
    GBs = "Not Implemented Yet",
    nb_loops_80_if_fully_vect = 6,
    experiment_type = "MPI; ",
    nb_loops_80_if_clean = 2,
    speedup_if_fully_vectorised = "1.29",
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = "1.00",
    speedup_if_clean = "1.02",
    innerloops_time = 27.5,
    array_access_efficiency = "27.68",
    profiled_time = 0.07,
    number_processes = 3,
    crest_performance = "Not Implemented Yet",
    nb_threads = 3,
    application_time = 0.07,
  ...
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops. It represents 0.02 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops. It represents 0.02 seconds.",
