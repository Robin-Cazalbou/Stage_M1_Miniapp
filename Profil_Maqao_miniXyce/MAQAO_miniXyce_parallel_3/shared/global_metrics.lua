_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = "35.33",
    speedup_if_perfect_MPI_OMP_PTHREAD = "24.27",
    ...
    innerloops_time = 0.63,
    array_access_efficiency = "16.70",
    profiled_time = 136.24,
    number_processes = 3,
    crest_performance = "Not Implemented Yet",
    nb_threads = 3,
    application_time = 136.24,
  ...
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops. It represents 1.46 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops. It represents 0.86 seconds.",
