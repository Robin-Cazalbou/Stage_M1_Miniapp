_report = {
  metrics = {
    ...
    nb_loops_80_if_fully_vect = 5,
    experiment_type = "MPI; ",
    nb_loops_80_if_clean = 2,
    speedup_if_fully_vectorised = "1.75",
    nb_loops_80_if_fp_vect = 4,
    flow_complexity = "1.06",
    speedup_if_clean = "1.23",
    innerloops_time = 37.38,
    array_access_efficiency = "44.89",
    profiled_time = 2.6,
    number_processes = 1,
    crest_performance = "Not Implemented Yet",
    nb_threads = 1,
    application_time = 2.6,
  ...
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops. It represents 1.47 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops. It represents 0.97 seconds.",
