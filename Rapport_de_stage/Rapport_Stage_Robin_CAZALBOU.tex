...
%
%
% préciser qu'on remplit une matrice H avec les h_i calculés et que c'est une matrice d'Hessenberg
%
%
%
...
% définition d'une rotation de Givens
% théorème sur la factorisation QR de la matrice de Hessenberg H
% "théorème de GMRES", c'est-à-dire sur la page wikipédia de GMRES avec la minimisation du résidu, ce qu'est le vecteur g, etc.

\subsection{\'Etapes de déroulement de la méthode}

% marquer chacune des étapes en s'appuyant sur ce qui a été expliqué dans les sous-sections précédentes (étapes 1 à 5)



\section{Méthode d'implémentation de GMRES en OpenMP}

% méthodologie avec des tests uitaires, de la modularité, une structure storage qui contient des variables partagées pour les réductions et des variables dont la tailles est prévue à l'avance, etc.
