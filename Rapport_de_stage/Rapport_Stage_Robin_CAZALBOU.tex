...
% expliquer aussi le principe du restart, qui n'a pas été détaillé précédemment
...
% Q_i ne se stocke qu'avec une succession de paires de coefficients (cosinus et sinus)
